...
| **elasticsearch** | ![elasticsearch](/images/tema1/elasticsearch.jpg) | Diseñado para búsquedas y análisis de datos indexados, no para transacciones. Distribuido y escalable horizontalmente. Indexación inversa, consultas full-text, agregaciones complejas. | **Relacional** |
| **Amazon Aurora** | ![Amazon Aurora](/images/tema1/aurora.jpg) | Compatible con MySQL y PostgreSQL, con mejoras de rendimiento y escalabilidad. Arquitectura distribuida, recuperación rápida y replicación interna. Administrado como servicio (`AWS`) con alta disponibilidad integrada. | **Relacional** |
| **IBM DB2** | ![IBM DB2](/images/tema1/ibmdb2.jpg) | Alta fiabilidad y uso en entornos corporativos. Amplias capacidades de optimización y soporte para grandes volúmenes de datos. Soporte para múltiples plataformas. | **Relacional** |
| **Amazon RDS** | ![Amazon RDS](/images/tema1/amazon_rds.jpg) | Servicio gestionado de bases de datos, facilita el despliegue, mantenimiento, copias de seguridad automáticas. Soporta varios motores. Escalabilidad automática, replicación y alta disponibilidad integradas. | **Relacional** |
