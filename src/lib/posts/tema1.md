...
| **Amazon RDS** | ![Amazon RDS](/images/tema1/amazon rds.jpg) | Servicio gestionado de bases de datos, facilita el despliegue, mantenimiento, copias de seguridad automáticas. Soporta varios motores. Escalabilidad automática, replicación y alta disponibilidad integradas. | **Relacional** |
